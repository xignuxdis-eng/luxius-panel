  ...
  if (loading) {
    return (
      <div className={`relative ${className}`}>
        ...
        <div className="w-full px-3 py-2 border rounded-lg border-gray-300">
  ...
  if (error) {
    return (
      <div className={`relative ${className}`}>
        ...
        <div className="w-full px-3 py-2 border rounded-lg border-red-300">
        ...
        >
          <div className="flex items-center space-x-2">
            ...
            <span className={selectedClientId ? "text-gray-900" : "text-gray-500"}>
              {selectedClient ? `${selectedClient.nombre} ${selectedClient.apellido} - ${selectedClient.empresa || selectedClient.email}` : "Seleccionar cliente..."}
            </span>
          </div>
