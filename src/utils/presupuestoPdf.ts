...
const LOGO_BASE64 = XIGNUX_LOGO_LIGHT;
...
<body>
    ...
    <div class="meta-container">
        ...
        <div class="meta-right">
            ...
            <div style="font-weight: 700; font-size: 14px; text-transform: uppercase; color: #475569; margin-top: 10px;">${data.vendedorNombre}</div>
        </div>
    </div>
