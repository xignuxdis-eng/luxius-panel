...
export default function UploadPage() {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    if (uploadMode === "individual") {
      ...
      // Modo lotes: validar que haya archivos seleccionados
      if (selectedFiles.length === 0) {
        alert("Por favor selecciona al menos un archivo del lote");
        return;
      }
    }
    ...
    const mensaje = uploadMode === "individual" 
      ? "¡Pedido individual agregado a la lista de pendientes!" 
    ...
    <div className="space-y-6">
      ...
      <div className="bg-white rounded-lg shadow-sm p-6 border border-gray-200">
        <h1 className="text-2xl font-bold text-gray-800 mb-2">
          Subir Archivos para Nuevo Pedido 📁
        </h1>
        <p className="text-gray-600 mb-4">
          Sube tus archivos de diseño y completa la información del pedido. Los pedidos se irán acumulando hasta que los envíes.
        </p>
          ...
          <h2 className="text-lg font-semibold text-gray-800 mb-4 flex items-center">
            {uploadMode === "individual" ? (
              <>
                ...
                Información del Pedido Individual
              </>
            ) : (
              <>
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            <div>
              ...
              <input
                ...
                placeholder={uploadMode === "individual" ? "Ej: Lona para campaña electoral" : "Ej: Lote de 10 banners"}
                required
              />
            </div>
      ...
      {selectedFile && (
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
          <div className="bg-white rounded-lg p-6 max-w-4xl max-h-[90vh] overflow-hidden">
            ...
            {console.log("Modal - preview exists:", !!selectedFile.preview)}
