                                        ...
                                        {group.variants.map((v: Material) => {
                                            ...
                                            return (
                                                <div key={v.id} className="tank-3d-wrapper" onClick={() => handleOpenAdjustment(v)}>
                                                    ...
                                                    <div className="bottle-indicator" onClick={(e) => e.stopPropagation()} title="Botellas cerradas (stock fuera de máquina)" style={{ display: 'flex', flexDirection: 'column', gap: '4px', alignItems: 'center', marginTop: '4px' }}>
                                                        <div style={{ display: 'flex', alignItems: 'center', gap: '4px', justifyContent: 'center' }}>
                                                            ...
                                                            <button onClick={(e) => { e.stopPropagation(); handleAdjustBottles(v, 1) }} style={{ width: '18px', height: '18px', borderRadius: '4px', border: '1px solid var(--border)', background: 'var(--bg-hover)', color: 'var(--text-primary)', cursor: 'pointer', fontSize: '0.8rem', lineHeight: 1, display: 'flex', alignItems: 'center', justifyContent: 'center' }}>+</button>
                                                            <span style={{ fontSize: '0.6rem', color: 'var(--text-muted)' }}>cerradas</span>
                                                        </div>
                                                        <div style={{ display: 'flex', alignItems: 'center', gap: '4px', justifyContent: 'center' }}>
                                                            <input
                                                                ...
                                                                style={{ width: '56px', padding: '2px 4px', fontSize: '0.72rem', border: '1px solid var(--border)', borderRadius: '4px', background: 'var(--bg-hover)', color: 'var(--text-primary)', textAlign: 'center' }}
                                                                title="Mililitros sellados fuera de máquina"
                                                            />
                                                            <span style={{ fontSize: '0.6rem', color: 'var(--text-muted)' }}>ml</span>
                                                        </div>
                                                    </div>
