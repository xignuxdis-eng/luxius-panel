const fs = require('fs');
let content = fs.readFileSync('src/pages/Entrada/NuevoPedidoModal.tsx', 'utf8');
...
fs.writeFileSync('src/pages/Entrada/NuevoPedidoModal.tsx', content, 'utf8');
console.log('Fixed NuevoPedidoModal.tsx');
